...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║           🐱 BlackCat3D - Gato Negro Sentado (Meshy AI)                  ║
 * ╠══════════════════════════════════════════════════════════════════════════╣
 * ║  Modelo 3D del gato negro sentado en la barda mirando la luna.           ║
 * ║  Animación sutil de cola con oscilación sinusoidal.                     ║
 * ║  Rim light azulado simulando luz de luna.                               ║
 * ║                                                                          ║
 * ║  ESTADO: Activo - Modelos en assets locales                             ║
 * ║  Archivos en assets/models/:                                            ║
 * ║    - black_cat.obj                                                      ║
 * ║    - black_cat_texture.png                                              ║
 * ╚══════════════════════════════════════════════════════════════════════════╝
 */
public class BlackCat3D {
    private static final String TAG = "BlackCat3D";
    private static final String OBJ_ASSET_PATH = "models/black_cat.obj";
    private static final String TEXTURE_ASSET_PATH = "models/black_cat_texture.png";
    ...
    // Transform - positioned on the brick wall, lower-center of screen
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // SHADERS - Basic texture + moonlight rim light
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    private static final String FRAGMENT_SHADER =
        ...
        "    // Subtle moonlight rim (bluish light from upper-right)\n" +
        ...
        "    fragColor = vec4(texColor.rgb * breathe + rimColor, texColor.a);\n" +
        "}\n";
    ...
    private void initialize() {
        // Compile shader first (always needed)
        compileShader();

        // Try to load model from Supabase cache
        loadModel();

        // Try to load texture from Supabase cache
        loadTexture();
    }
