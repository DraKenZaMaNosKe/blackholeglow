...
public class ImageDownloadManager {
    ...
    /**
     * 🗑️ Elimina todas las imágenes EXCEPTO las especificadas.
    ...
    public long deleteAllExcept(java.util.List<String> keepFiles) {
        ...
        if (files == null || files.length == 0) {
            Log.d(TAG, "🗑️ No hay imágenes para limpiar");
            return 0;
        }
        ...
        Log.d(TAG, "🧹 Limpieza completada: " + deletedCount + " imágenes eliminadas, " +
